...
export const ja: Translation = {
	...
	// 天気予報
	[Key.weather]: "天気予報",
	[Key.weatherRetry]: "リトライ",
	[Key.weatherLoading]: "読み込み中...",
	[Key.weatherLocated]: "現在地",
	[Key.weatherError]: "天気データの取得に失敗",
	[Key.weatherLocationDenied]: "位置情報が拒否されました",

		// 时间线
				[Key.timeline]: "タイムライン",
		[Key.timelineSubtitle]: "私の成長とマイルストーン",
		...
		[Key.timelineNoResults]: "一致するエントリはありません",
		...
		[Key.projectsCourse]: "課題",
		[Key.projectsOther]: "その他",
		[Key.projectsTotal]: "合計",
