...
export const zh_TW: Translation = {
	...
	[Key.weatherLocated]: "當前定位",
	[Key.weatherError]: "天氣資料獲取失敗",
	[Key.weatherLocationDenied]: "定位授權被拒絕",
		...
		[Key.timelineYears]: "年",
		[Key.timelineCurrent]: "當前",
		[Key.timelineAchievements]: "成就榮譽",
		[Key.timelineNoResults]: "暫無匹配條目",
