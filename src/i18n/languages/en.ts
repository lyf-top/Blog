...
export const en: Translation = {
	...
	[Key.weatherLocated]: "Current location",
	[Key.weatherError]: "Failed to fetch weather",
	[Key.weatherLocationDenied]: "Location access denied",

		// 时间线
				[Key.timeline]: "Timeline",
		[Key.timelineSubtitle]: "My growth journey and milestones",
		...
		[Key.timelineNoResults]: "No matching entries",
