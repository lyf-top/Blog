...
export const ko: Translation = {
	...
	[Key.weatherLocated]: "현재 위치",
	[Key.weatherError]: "날씨 데이터를 가져오지 못했습니다",
	[Key.weatherLocationDenied]: "위치 접근이 거부되었습니다",

		// 时间线
				[Key.timeline]: "타임라인",
		[Key.timelineSubtitle]: "나의 성장 한마디",
		[Key.timelineEducation]: "교육",
		[Key.timelineWork]: "업무",
		[Key.timelineProject]: "프로젝트",
		[Key.timelineAchievement]: "업적",
		[Key.timelinePresent]: "현재",
		[Key.timelineMonths]: "개월",
		[Key.timelineYears]: "년",
		[Key.timelineCurrent]: "현재",
		[Key.timelineAchievements]: "성과",
		[Key.timelineNoResults]: "일치하는 항목이 없습니다",
		...
		[Key.projectsAll]: "전체",
		[Key.projectsWeb]: "웹 앱",
		[Key.projectsMobile]: "모바일 앱",
		[Key.projectsDesktop]: "데스크톱 앱",
		[Key.projectsCourse]: "과제",
		...
		[Key.projectsFeatured]: "추천",
		[Key.projectsPlanned]: "예정",
		[Key.projectsDemo]: "데모",
