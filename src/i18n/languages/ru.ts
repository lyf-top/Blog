...
export const ru: Translation = {
	...
	[Key.weatherLocated]: "Текущее местоположение",
	[Key.weatherError]: "Не удалось получить данные о погоде",
	[Key.weatherLocationDenied]: "Доступ к местоположению запрещён",
		...
		[Key.timelinePresent]: "По настоящее время",
		[Key.timelineMonths]: "мес.",
		[Key.timelineYears]: "г.",
		[Key.timelineCurrent]: "Текущий",
		[Key.timelineAchievements]: "Достижения",
		[Key.timelineNoResults]: "Нет соответствующих записей",

		// 项目展示
				[Key.projects]: "Проекты",
		[Key.projectsSubtitle]: "Портфолио проектов",
		[Key.projectsAll]: "Все",
		[Key.projectsWeb]: "Веб",
		[Key.projectsMobile]: "Мобильные",
		[Key.projectsDesktop]: "Десктоп",
		[Key.projectsCourse]: "Курсовые",
		[Key.projectsOther]: "Другое",
		[Key.projectsTotal]: "Всего",
		...
		[Key.projectsPlanned]: "Планируется",
