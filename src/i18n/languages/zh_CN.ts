...
export const zh_CN: Translation = {
	...
	[Key.weatherLocated]: "当前定位",
	[Key.weatherError]: "天气数据获取失败",
	[Key.weatherLocationDenied]: "定位授权被拒绝",
		...
		[Key.timelineYears]: "年",
		[Key.timelineCurrent]: "当前",
		[Key.timelineAchievements]: "成就荣誉",
		[Key.timelineNoResults]: "暂无匹配条目",
